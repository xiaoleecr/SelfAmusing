    ...
    <form name="regForm" action="register" method="post" >
			  <table border="0" width="800" cellspacing="0" cellpadding="0">
			    ...
			    <tr>
			    	...
			    	<td class="controler"><input id="password" type="password" name="mypassword" ></td>
			    	
			    </tr>
			    <tr>
			    	<td class="label">确认密码：</td>
			    	<td class="controler"><input id="confirm" type="password" onblur="confirmPwd();" name="confirmpass" ><a id="warm" style="visibility:hidden;color:red" >两次密码不一致</a></td>
			    ...
			    <tr>
			    	...
			    	<td class="controler">
			    		<textarea name="introduce" rows="10" cols="40" style="resize:none"></textarea>
			    	</td>
			    </tr>
			    <tr>
